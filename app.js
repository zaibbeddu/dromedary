...
var serverPort = process.env.PORT || 18080;
var siteChartStore = {};
var ddbLastFetch = {};
...
// GET requests to /logo return the logo image file
app.get('/logo', function(req, res) {
  if (featureToggles.liatriofy === true) {
    res.sendFile(__dirname + '/public/liatrio.png');
  } else {
    res.sendFile(__dirname + '/public/stelogo.png');
  }
});
